...
<body>
    <header>
        ...
        <div class="logo"><a href="Pagina1.html"><img src="/imagenes/logo.jpeg"></a></div>

        <ul class="VEHÍCULOS">
            <li><a href="">VEHÍCULOS</a>
                <ul>
                    <li><a href="https://www.youtube.com/watch?v=oZa2Ut8u2S0">TODOS LOS MODELOS</a></li>
                    <li><a href="https://www.youtube.com/watch?v=oZa2Ut8u2S0">AUTOS</a></li>
                    <li><a href="https://www.youtube.com/watch?v=oZa2Ut8u2S0">CAMIONETAS</a></li>
                    <li><a href="https://www.youtube.com/watch?v=oZa2Ut8u2S0">PICK-UPS</a></li>
                    <li><a href="https://www.youtube.com/watch?v=oZa2Ut8u2S0">COMERCIALES</a></li>
                </ul>
            </li>
        </ul>
        ...
        <div class="ventana-emergente">
            <div class="modal-content">
                ...
                <p>Para usar esta función, tienes que iniciar sesión.</p>
                <img src="/imagenes/IconoLogin2.jpeg">
                </br>
        ...
        <a href="Login.php" class="enlace-InicioSesion">
            <img src="/imagenes/iconoLogin.png" style="width: 60px;">
        </a>
        ...
        <a href="#" class="enlace-whatsapp">
            <img src="/imagenes/logowats.png" alt="logowats">
            <span class="tooltip">
...
<body5>
    ...
    <div class="encabezado3">
        © 2021 - 2024 Todos los derechos reservados AUTOMOTRIZ CISNE S.R.L. // RUC: 20454537743
    </div>
